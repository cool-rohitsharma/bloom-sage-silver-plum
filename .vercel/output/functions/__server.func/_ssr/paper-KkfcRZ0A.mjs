...
//#region node_modules/.nitro/vite/services/ssr/assets/paper-KkfcRZ0A.js
...
function Paper({ children, className, ruled = true }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("article", {
		className: cn("w-full min-w-0 rounded-xl border border-ink/10", ruled ? "paper-sheet" : "bg-paper shadow-[var(--shadow-page)]", className),
...
function SourcePill({ source }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		className: "inline-flex items-center rounded-full border border-ink/15 bg-wash/70 px-2.5 py-0.5 text-xs tracking-wide text-steel",
		children: source === "merged" ? "both sheets" : source === "filled" ? "filled gap" : source === "cheatcode" ? "CheatCode" : "Ultimate"
	});
}
function LevelPill({ level }) {
	const text = level === "trap" ? "trap" : level === "deep" ? "deep" : "core";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		className: cn("inline-flex items-center rounded-full px-2.5 py-0.5 text-xs", level === "trap" ? "bg-rule/10 text-rule" : level === "deep" ? "bg-warn/10 text-warn" : "bg-ink/8 text-ink-soft"),
		children: text
	});
}
//#endregion
export { drills as i, Paper as n, SourcePill as r, LevelPill as t };
